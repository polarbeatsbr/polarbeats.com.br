...
const colorAssets = {
  black: 'produto-black.png',
  white: 'produto-white.png'
};
...
const translations = {
  pt: {
    ...
    tablet_caption: "Controle também via tablet",
    onde_kicker: "Onde Instalar",
    onde_title: "UM PRODUTO. INFINITOS AMBIENTES.",
    onde_lead: "Do quarto ao hotel cinco estrelas. Do home office à academia. A Polar Beats se adapta a qualquer espaço onde clima e som fazem a diferença.",
    onde_tag_res: "Residencial",
    onde_tag_sleep: "Sleep Mode",
    onde_photo1_title: "Sala de Estar",
    onde_photo1_desc: "Clima e som premium para toda a família.",
    onde_photo2_title: "Cozinha & Gourmet",
    onde_photo2_desc: "Conforto e trilha sonora enquanto você recebe.",
    onde_photo3_title: "Quarto",
    onde_photo3_desc: "Sons ambiente e temperatura ideal para o sono.",
    onde_com1_title: "Hotéis & Resorts",
    onde_com1_desc: "Experiência premium em cada apartamento — clima controlado e som ambiente sem equipamentos extras.",
    onde_com2_title: "Airbnb & Temporada",
    onde_com2_desc: "Diferencial competitivo que eleva avaliações e justifica diárias mais altas.",
    onde_com3_title: "Academias & Estúdios",
    onde_com3_desc: "Alta energia sonora e climatização ideal — cobertura 180° que motiva cada treino.",
    onde_com4_title: "Clínicas & Consultórios",
    onde_com4_desc: "Ruído branco mascarante e temperatura confortável para pacientes e profissionais.",
    onde_com5_title: "Restaurantes & Bares",
    onde_com5_desc: "Sonorização ambiente discreta integrada ao ar — sem caixas na parede, só elegância.",
    onde_com6_title: "Salões & Spas",
    onde_com6_desc: "Sons relaxantes e clima perfeito para a experiência completa de bem-estar.",
    onde_com7_title: "Escritórios & Coworkings",
    onde_com7_desc: "Produtividade máxima com som mascarante de ruído e temperatura constante.",
    onde_com8_title: "Lojas & Showrooms",
    onde_com8_desc: "Mais tempo de permanência, mais conversões — trilha sonora e clima que vendem.",
    amb1_title: "Hotéis & Resorts",
    amb1_desc: "Som e clima premium integrados em cada suíte — sem cabos, sem caixas, sem poluição visual. Experiência cinco estrelas.",
    amb2_title: "Motéis & Pousadas",
    amb2_desc: "Atmosfera sonora personalizada e clima silencioso para proporcionar conforto, privacidade e experiência diferenciada aos hóspedes.",
    amb3_title: "Salões de Festa & Eventos",
    amb3_desc: "Áudio de cobertura distribuída em 180° e climatização potente mantêm o ambiente perfeito durante toda a festa.",
    amb4_title: "Salas Gourmet & Varandas",
    amb4_desc: "Churrascos, jantares e recepções elevados por som premium e clima agradável — tudo em um único aparelho elegante.",
    amb5_title: "Clínicas & Consultórios",
    amb5_desc: "Ruído branco para mascaramento acústico e som relaxante que criam privacidade nas consultas e tranquilidade na sala de espera.",
    amb6_title: "Academias & Estúdios de Dança",
    amb6_desc: "Climatização ideal e som de alta energia com cobertura uniforme em 180° — a combinação que motiva cada treino.",
    amb7_title: "Restaurantes & Bares",
    amb7_desc: "Sonorização ambiente discreta integrada ao ar-condicionado — sem caixas na parede, sem cabos à vista, só elegância e conforto.",
    amb8_title: "Salas de Reunião & Escritórios",
    amb8_desc: "Produtividade máxima com clima controlado e som mascarante de ruído de fundo para reuniões e home office.",
    amb9_title: "Lojas & Showrooms",
    amb9_desc: "Trilha sonora ambiente e clima perfeitos para aumentar o tempo de permanência do cliente e melhorar a experiência de compra.",
    amb10_title: "Spas & Centros de Estética",
    amb10_desc: "Sons da natureza, frequências terapêuticas e temperatura ideal para relaxamento profundo — a experiência spa completa.",
    amb11_title: "Casas & Home Theaters",
    amb11_desc: "Clima aconchegante e som espacial para quartos e salas — substitui caixas acústicas convencionais com muito mais elegância.",
    amb12_title: "Escolas & Universidades",
    amb12_desc: "Salas de aula climatizadas com som claro e homogêneo — melhor concentração e aprendizado para alunos e professores.",
    amb13_title: "Igrejas & Templos",
    amb13_desc: "Sonorização reverberante de alta qualidade e climatização silenciosa para cultos, celebrações e momentos de paz.",
    amb14_title: "Quartos de Hotel & Suítes",
    amb14_desc: "Controle individual de som e temperatura no app — hóspedes personalizam a própria experiência sem chamar a recepção.",
    amb15_title: "Lounges & Áreas VIP",
    amb15_desc: "Atmosfera exclusiva e sofisticada para áreas VIP — som premium e clima perfeito que elevam o status do ambiente.",
    amb16_title: "Recepções & Lobbies",
    amb16_desc: "Primeira impressão impecável: som ambiente discreto e temperatura confortável que dão boas-vindas a clientes e visitantes.",
    amb_cta_title: "Instalável em qualquer ambiente do mundo",
    amb_cta_desc: "Se o local precisa de ar-condicionado, a Polar Beats pode ser instalada — residencial, comercial, industrial ou de lazer. Um produto, possibilidades infinitas."
  },
  en: {
    nav_product: "Product",
    nav_origin: "Origin",
    ...
    tablet_caption: "Also controllable via tablet",
    onde_kicker: "Where to Install",
    onde_title: "ONE PRODUCT. INFINITE SPACES.",
    onde_lead: "From the bedroom to a five-star hotel. From the home office to the gym. Polar Beats adapts to any space where climate and sound make a difference.",
    onde_tag_res: "Residential",
    onde_tag_sleep: "Sleep Mode",
    onde_photo1_title: "Living Room",
    onde_photo1_desc: "Premium climate and sound for the whole family.",
    onde_photo2_title: "Kitchen & Gourmet",
    onde_photo2_desc: "Comfort and a soundtrack while you entertain.",
    onde_photo3_title: "Bedroom",
    onde_photo3_desc: "Ambient sounds and the ideal temperature for sleep.",
    onde_com1_title: "Hotels & Resorts",
    onde_com1_desc: "Premium experience in every room — controlled climate and ambient sound with no extra equipment.",
    onde_com2_title: "Airbnb & Vacation Rentals",
    onde_com2_desc: "A competitive edge that boosts reviews and justifies higher nightly rates.",
    onde_com3_title: "Gyms & Studios",
    onde_com3_desc: "High-energy sound and ideal cooling — 180° coverage that fuels every workout.",
    onde_com4_title: "Clinics & Medical Offices",
    onde_com4_desc: "White noise masking and comfortable temperature for patients and professionals.",
    onde_com5_title: "Restaurants & Bars",
    onde_com5_desc: "Discreet ambient sound integrated into the AC — no wall speakers, just elegance.",
    onde_com6_title: "Salons & Spas",
    onde_com6_desc: "Relaxing sounds and perfect climate for the complete wellness experience.",
    onde_com7_title: "Offices & Coworking Spaces",
    onde_com7_desc: "Maximum productivity with noise-masking sound and constant temperature.",
    onde_com8_title: "Retail Stores & Showrooms",
    onde_com8_desc: "More dwell time, more conversions — a soundtrack and climate that sell.",
    amb1_title: "Hotels & Resorts",
    amb1_desc: "Integrated premium sound and climate in every suite — no cables, no speakers, no visual clutter. A five-star experience.",
    amb2_title: "Motels & Inns",
    amb2_desc: "Custom soundscapes and silent climate control for comfort, privacy, and a distinctive guest experience.",
    amb3_title: "Party Halls & Event Venues",
    amb3_desc: "180° distributed audio coverage and powerful cooling keep the atmosphere perfect throughout the event.",
    amb4_title: "Gourmet Rooms & Terraces",
    amb4_desc: "Barbecues, dinners, and gatherings elevated by premium sound and pleasant climate — all in one elegant unit.",
    amb5_title: "Clinics & Medical Offices",
    amb5_desc: "White noise for acoustic masking and relaxing sounds that create privacy in consultations and calm in the waiting room.",
    amb6_title: "Gyms & Dance Studios",
    amb6_desc: "Ideal cooling and high-energy sound with uniform 180° coverage — the combination that fuels every workout.",
    amb7_title: "Restaurants & Bars",
    amb7_desc: "Discreet ambient sound integrated into the air conditioner — no wall speakers, no visible cables, just elegance and comfort.",
    amb8_title: "Meeting Rooms & Offices",
    amb8_desc: "Maximum productivity with controlled climate and background noise-masking sound for meetings and home offices.",
    amb9_title: "Retail Stores & Showrooms",
    amb9_desc: "Ambient soundtrack and perfect climate to increase customer dwell time and improve the shopping experience.",
    amb10_title: "Spas & Beauty Centers",
    amb10_desc: "Nature sounds, therapeutic frequencies, and the ideal temperature for deep relaxation — the complete spa experience.",
    amb11_title: "Homes & Home Theaters",
    amb11_desc: "Cozy climate and spatial sound for bedrooms and living rooms — replaces conventional speakers with far more elegance.",
    amb12_title: "Schools & Universities",
    amb12_desc: "Air-conditioned classrooms with clear, even sound — better focus and learning for students and teachers.",
    amb13_title: "Churches & Temples",
    amb13_desc: "High-quality reverberant sound and silent cooling for worship, celebrations, and moments of peace.",
    amb14_title: "Hotel Rooms & Suites",
    amb14_desc: "Individual sound and temperature control via the app — guests personalize their own experience without calling the front desk.",
    amb15_title: "Lounges & VIP Areas",
    amb15_desc: "Exclusive and sophisticated atmosphere for VIP areas — premium sound and perfect climate that elevate the venue's status.",
    amb16_title: "Reception Areas & Lobbies",
    amb16_desc: "A flawless first impression: discreet ambient sound and comfortable temperature that welcome clients and visitors.",
    amb_cta_title: "Installable in any space worldwide",
    amb_cta_desc: "If the space needs air conditioning, Polar Beats can be installed — residential, commercial, industrial, or leisure. One product, infinite possibilities."
  },
  es: {
    ...
    sim_sleep_title: "Modo Sueño Profundo y Ruido Blanco",
    sim_sleep_desc: "Emite sonidos relajantes de la naturaleza combinados con frecuencias que neutralizan el ruido de la calle. Ajusta la refrigeración al metabolismo durante el sueño.",
    duo_black_desc: "Acabado grafito cepillado con anillo Aura LED.",
    duo_white_desc: "Acabado blanco polar con anillo Aura LED.",
    tablet_caption: "También controlable desde tablet",
    onde_kicker: "Dónde Instalar",
    onde_title: "UN PRODUCTO. INFINITOS ESPACIOS.",
    onde_lead: "Del dormitorio al hotel cinco estrellas. De la oficina al gimnasio. Polar Beats se adapta a cualquier espacio donde el clima y el sonido marcan la diferencia.",
    onde_tag_res: "Residencial",
    onde_tag_sleep: "Sleep Mode",
    onde_photo1_title: "Sala de Estar",
    onde_photo1_desc: "Clima y sonido premium para toda la familia.",
    onde_photo2_title: "Cocina & Gourmet",
    onde_photo2_desc: "Confort y banda sonora mientras recibes invitados.",
    onde_photo3_title: "Dormitorio",
    onde_photo3_desc: "Sonidos ambientales y temperatura ideal para dormir.",
    onde_com1_title: "Hoteles & Resorts",
    onde_com1_desc: "Experiencia premium en cada habitación — clima controlado y sonido ambiental sin equipos adicionales.",
    onde_com2_title: "Airbnb & Alquiler Vacacional",
    onde_com2_desc: "Diferencial competitivo que eleva valoraciones y justifica tarifas más altas.",
    onde_com3_title: "Gimnasios & Estudios",
    onde_com3_desc: "Alta energía sonora y climatización ideal — cobertura 180° que motiva cada entrenamiento.",
    onde_com4_title: "Clínicas & Consultorios",
    onde_com4_desc: "Ruido blanco enmascarante y temperatura confortable para pacientes y profesionales.",
    onde_com5_title: "Restaurantes & Bares",
    onde_com5_desc: "Sonorización ambiental discreta integrada al aire — sin altavoces en la pared, solo elegancia.",
    onde_com6_title: "Salones & Spas",
    onde_com6_desc: "Sonidos relajantes y clima perfecto para la experiencia completa de bienestar.",
    onde_com7_title: "Oficinas & Coworkings",
    onde_com7_desc: "Productividad máxima con sonido enmascarante de ruido y temperatura constante.",
    onde_com8_title: "Tiendas & Showrooms",
    onde_com8_desc: "Más tiempo de permanencia, más conversiones — banda sonora y clima que venden.",
    amb1_title: "Hoteles & Resorts",
    amb1_desc: "Sonido y clima premium integrados en cada suite — sin cables, sin altavoces, sin contaminación visual. Experiencia cinco estrellas.",
    amb2_title: "Moteles & Posadas",
    amb2_desc: "Atmósfera sonora personalizada y clima silencioso para brindar confort, privacidad y una experiencia diferenciada a los huéspedes.",
    amb3_title: "Salones de Fiesta & Eventos",
    amb3_desc: "Audio con cobertura distribuida de 180° y climatización potente que mantienen el ambiente perfecto durante toda la fiesta.",
    amb4_title: "Salas Gourmet & Terrazas",
    amb4_desc: "Asados, cenas y recepciones elevados por sonido premium y clima agradable — todo en un único equipo elegante.",
    amb5_title: "Clínicas & Consultorios",
    amb5_desc: "Ruido blanco para enmascaramiento acústico y sonido relajante que crean privacidad en las consultas y tranquilidad en la sala de espera.",
    amb6_title: "Gimnasios & Estudios de Danza",
    amb6_desc: "Climatización ideal y sonido de alta energía con cobertura uniforme de 180° — la combinación que motiva cada entrenamiento.",
    amb7_title: "Restaurantes & Bares",
    amb7_desc: "Sonorización ambiental discreta integrada al aire acondicionado — sin altavoces en la pared, sin cables a la vista, solo elegancia y confort.",
    amb8_title: "Salas de Reunión & Oficinas",
    amb8_desc: "Productividad máxima con clima controlado y sonido enmascarante de ruido de fondo para reuniones y home office.",
    amb9_title: "Tiendas & Showrooms",
    amb9_desc: "Banda sonora ambiental y clima perfectos para aumentar el tiempo de permanencia del cliente y mejorar la experiencia de compra.",
    amb10_title: "Spas & Centros de Estética",
    amb10_desc: "Sonidos de la naturaleza, frecuencias terapéuticas y temperatura ideal para la relajación profunda — la experiencia spa completa.",
    amb11_title: "Casas & Home Theaters",
    amb11_desc: "Clima acogedor y sonido espacial para dormitorios y salas — reemplaza los altavoces convencionales con mucha más elegancia.",
    amb12_title: "Escuelas & Universidades",
    amb12_desc: "Aulas climatizadas con sonido claro y homogéneo — mejor concentración y aprendizaje para alumnos y profesores.",
    amb13_title: "Iglesias & Templos",
    amb13_desc: "Sonorización reverberante de alta calidad y climatización silenciosa para cultos, celebraciones y momentos de paz.",
    amb14_title: "Habitaciones de Hotel & Suites",
    amb14_desc: "Control individual de sonido y temperatura en la app — los huéspedes personalizan su propia experiencia sin llamar a recepción.",
    amb15_title: "Lounges & Áreas VIP",
    amb15_desc: "Atmósfera exclusiva y sofisticada para áreas VIP — sonido premium y clima perfecto que elevan el estatus del espacio.",
    amb16_title: "Recepciones & Lobbies",
    amb16_desc: "Primera impresión impecable: sonido ambiental discreto y temperatura confortable que dan la bienvenida a clientes y visitantes.",
    amb_cta_title: "Instalable en cualquier espacio del mundo",
    amb_cta_desc: "Si el espacio necesita aire acondicionado, Polar Beats puede instalarse — residencial, comercial, industrial o de ocio. Un producto, posibilidades infinitas."
  }
};
